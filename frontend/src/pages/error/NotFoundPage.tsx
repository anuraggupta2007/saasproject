    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-4">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-8xl font-bold bg-gradient-to-r from-violet-400 via-pink-400 to-indigo-400 bg-clip-text text-transparent mb-4"
        >
          404
        </motion.h1>
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 text-gray-300 font-medium hover:bg-white/10 hover:text-white transition-all duration-200"
          >
